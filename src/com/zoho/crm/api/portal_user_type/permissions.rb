  ...
  module PortalUserType
    class Permissions
      ...
      def view
        ...
        # @param view [Util::Choice] An instance of Util::Choice

      def view=(view)
        if view!=nil and !view.is_a? Util::Choice
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: view EXPECTED TYPE: Util::Choice', nil, nil)
        end
        @view = view
        @key_modified['view'] = 1
      end
