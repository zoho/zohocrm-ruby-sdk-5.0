  ...
  module EntityScores
    class EntityScores
      ...
      def negative_score=(negative_score)
        ...
        # @return An instance of EntityStructureGroup
      ...
      def entity
        ...
        # @param entity [EntityStructureGroup] An instance of EntityStructureGroup

      def entity=(entity)
        if entity!=nil and !entity.is_a? EntityStructureGroup
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: entity EXPECTED TYPE: EntityStructureGroup', nil, nil)
        end
        @entity = entity
        ...
        # @return An instance of ScoringRuleStructure
      ...
      def scoring_rule
        ...
        # @param scoring_rule [ScoringRuleStructure] An instance of ScoringRuleStructure

      def scoring_rule=(scoring_rule)
        if scoring_rule!=nil and !scoring_rule.is_a? ScoringRuleStructure
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: scoring_rule EXPECTED TYPE: ScoringRuleStructure', nil, nil)
        end
