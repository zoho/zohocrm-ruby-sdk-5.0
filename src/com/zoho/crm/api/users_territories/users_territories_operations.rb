...
module ZOHOCRMSDK
  module UsersTerritories
    class UsersTerritoriesOperations
      ...
      # @raise SDKException
      def get_territories_of_user(user)
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def associate_territories_to_user(user, request)
        if !user.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: user EXPECTED TYPE: Integer', nil, nil)
        end
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def get_territory_of_user(territory, user)
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def validate_before_transfer_for_all_territories(user)
        if !user.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: user EXPECTED TYPE: Integer', nil, nil)
        end
        handler_instance = Handler::CommonAPIHandler.new
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def validate_before_transfer(territory, user)
        if !territory.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: territory EXPECTED TYPE: Integer', nil, nil)
        end
        if !user.is_a? Integer
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def delink_and_transfer_from_all_territories(user, request)
        if !user.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: user EXPECTED TYPE: Integer', nil, nil)
        end
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def delink_and_transfer_from_specific_territory(territory, user, request)
        if !territory.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: territory EXPECTED TYPE: Integer', nil, nil)
        end
        if !user.is_a? Integer
