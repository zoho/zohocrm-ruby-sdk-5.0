  ...
  module AssignmentRules
    class AssignmentRules
      ...
      def api_name=(api_name)
        ...
        # @return An instance of CreatedBy
      ...
      def modified_by
        ...
        # @param modified_by [CreatedBy] An instance of CreatedBy

      def modified_by=(modified_by)
        if modified_by!=nil and !modified_by.is_a? CreatedBy
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: modified_by EXPECTED TYPE: CreatedBy', nil, nil)
        end
      ...
      def created_by
        ...
        # @param created_by [CreatedBy] An instance of CreatedBy

      def created_by=(created_by)
        if created_by!=nil and !created_by.is_a? CreatedBy
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: created_by EXPECTED TYPE: CreatedBy', nil, nil)
        end
