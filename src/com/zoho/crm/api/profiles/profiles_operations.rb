  ...
  module Profiles
    class ProfilesOperations
      ...
      def get_profiles(param_instance=nil)
        ...
        # @param request [ProfileWrapper] An instance of ProfileWrapper
        # @return An instance of APIResponse
      # @raise SDKException
      def clone_profiles(id, request)
        ...
        if request!=nil and !request.is_a? ProfileWrapper
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: request EXPECTED TYPE: ProfileWrapper', nil, nil)
        end
        handler_instance = Handler::CommonAPIHandler.new
        api_path = ''
        api_path = api_path + '/crm/v5/settings/profiles/'
