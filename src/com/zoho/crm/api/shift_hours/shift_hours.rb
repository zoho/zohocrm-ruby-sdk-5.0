  ...
  module ShiftHours
    class ShiftHours
      ...
      def timezone
        ...
        # @param timezone [TZInfo::Timezone] An instance of TZInfo::Timezone

      def timezone=(timezone)
        if timezone!=nil and !timezone.is_a? TZInfo::Timezone
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: timezone EXPECTED TYPE: TZInfo::TimeZone', nil, nil)
        end
        @timezone = timezone
