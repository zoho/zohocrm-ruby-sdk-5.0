...
class UpdateRelatedRecord
		def self.update_related_record(module_api_name, record_id, related_list_api_name, related_list_id)
	...
	def self.initialize_and_call
			begin
				...
				related_list_id = 34770614994115
				update_related_record(module_api_name, record_id, related_list_api_name, related_list_id)
			rescue Exception => e
				raise e
			end
		end
