...
class DelinkRecord
		def self.delink_record(module_api_name, record_id, related_list_api_name, related_list_id)
	...
	def self.initialize_and_call
			begin
				...
				delink_record(module_api_name, record_id, related_list_api_name, related_list_id)
			rescue Exception => e
				raise e
			end
		end
