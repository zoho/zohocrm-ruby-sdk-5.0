...
class RemoveTerritoriesFromRecord
		def self.remove_territories_from_record(module_api_name, id)
		 ...
		 # Call addKeyValue method that takes two arguments 1 -> A string that is the Field's API Name 2 -> Value
			...
			# Call remove_territories_from_record method that takes module_api_name, record_id and BodyWrapper instance as parameter
	...
	def self.initialize_and_call
			begin
				...
				remove_territories_from_record(module_api_name, record_id)
			rescue Exception => e
				raise e
			end
		end
