...
class Products
		def self.update_products(module_1)
			...
			record1.id = 3034553467895
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Product_name, "product_name")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Product_code, "product_code")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Product_active, true)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Product_category,  ZOHOCRMSDK::Util::Choice.new("software"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Sales_end_date, Date.new(2023, 12, 25))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Support_expiry_date, Date.new(2025, 12, 12))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Sales_start_date, Date.new(2023, 06, 12))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Support_start_date, Date.new(2023, 06, 20))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Manufacturer,  ZOHOCRMSDK::Util::Choice.new("met_beat Corp."))
			vendor=ZOHOCRMSDK::Record::Record.new
			vendor.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.id, 4402481054948)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Vendor_name, vendor)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Description, "description of product")
			# price info of Product
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Unit_price, 33.22)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Commission_rate, 12.2)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Taxable, true)
			taxes=[]
			...
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Usage_unit,  ZOHOCRMSDK::Util::Choice.new("box"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Qty_in_stock, 10.0)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Qty_in_demand, 5.0)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Qty_ordered, 5.0)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Products.Reorder_level, 0.0)
	...
	def self.initialize_and_call
			begin
				...
				update_products(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
Products.initialize_and_call