...
class Cases
		def self.update_cases(module_1)
			...
			product_name=ZOHOCRMSDK::Record::Record.new
			product_name.add_key_value("id", 321334231321)
			...
			contact_name.add_key_value("id", 31212323012312232)
