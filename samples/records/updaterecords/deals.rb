...
class Deals
		def self.update_deals(module_1)
			...
			record1.id = 322324
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Deal_name, "deal_name")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Amount, 100.0)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Closing_date, Date.new(2023, 12, 12))
			account=ZOHOCRMSDK::Record::Record.new
			account.id = 31212001
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Account_name, account)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Stage,  ZOHOCRMSDK::Util::Choice.new("qualification"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Probability, 10)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Type,  ZOHOCRMSDK::Util::Choice.new("new Business"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Next_step, nil)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Lead_source,  ZOHOCRMSDK::Util::Choice.new("advertisement"))
			contact_name=ZOHOCRMSDK::Record::Record.new
			contact_name.id = 40220020342313
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Contact_name, contact_name)
			compaign=ZOHOCRMSDK::Record::Record.new
			compaign.id = 322311243223
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Campaign_source, compaign)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Deals.Description, "description")
	...
	def self.initialize_and_call
			begin
				...
				update_deals(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
Deals.initialize_and_call