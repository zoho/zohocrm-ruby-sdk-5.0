...
class GetHolidays
		def self.get_holidays
			...
			paraminstance.add(ZOHOCRMSDK::Holidays::HolidaysOperations::GetHolidaysParam.year, 2024)
	# 		paraminstance.add(ZOHOCRMSDK::Holidays::GetHolidaysParam.shift_id, 440248001286017)
			response = holidaysoperations.get_holidays(paraminstance)
			if response != nil
				...
				if response.is_expected
					...
					if response_handler.is_a? ZOHOCRMSDK::Holidays::ResponseWrapper
						...
						if info != nil
							print "info : ".to_s + "\n"
							print "perpage : " + info.per_page.to_s + "\n"
							print "count : " + info.count.to_s + "\n"
							print "page : " + info.page.to_s + "\n"
							print "more_records : " + info.more_records.to_s + "\n"
						end
...
GetHolidays.initialize_and_call
