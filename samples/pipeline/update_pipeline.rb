...
class UpdatePipeline
	...
	def self.initialize_and_call
			begin
				...
				update_pipeline(layout_id, pipeline_id)
			rescue Exception => e
				raise e
			end
		end
