...
class GetUsers
		def self.get_users
			...
			# param_instance.add(ZOHOCRMSDK::Users::UsersOperations::GetUsersParam.per_page, 1)
			header_instance =  ZOHOCRMSDK::HeaderMap.new
			ifmodifiedsince = DateTime.new(2020, 01, 02, 10, 00, 01, '+05:30')
				...
				if response.is_expected
					...
					if response_handler.is_a? ZOHOCRMSDK::Users::ResponseWrapper
						...
						users.each do |user|
							...
							print "user Status: " + user.category.to_s + "\n"
						end
