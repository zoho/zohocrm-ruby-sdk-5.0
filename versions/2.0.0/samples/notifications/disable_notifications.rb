...
class DisableNotifications
		def self.disable_notifications(channel_ids)
			...
			param_instance =  ZOHOCRMSDK::Notifications::ParameterMap.new
			channel_ids.each do |id|
				param_instance.add(ZOHOCRMSDK::Notifications::NotificationsOperations::DeleteNotificationParam.channel_ids, id)
			end
	...
	def self.initialize_and_call
			begin
				...
				channel_ids=[]
				disable_notifications(channel_ids)
			rescue Exception => e
				raise e
			end
		end
end
DisableNotifications.initialize_and_call