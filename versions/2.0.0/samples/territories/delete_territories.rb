...
class DeleteTerritories
		def self.delete_territories
			territories_operations =  ZOHOCRMSDK::Territories::TerritoriesOperations.new
			param_instance =  ZOHOCRMSDK::ParameterMap.new
			param_instance.add(ZOHOCRMSDK::Territories::TerritoriesOperations::DeleteTerritoriesParam.ids, "440248001304069")
			param_instance.add(ZOHOCRMSDK::Territories::TerritoriesOperations::DeleteTerritoriesParam.delete_previous_forecasts, false)
...
DeleteTerritories.initialize_and_call