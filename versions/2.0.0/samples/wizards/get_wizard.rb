...
class GetWizard
		def self.get_wizard(wizard_id)
			wizards_operations =  ZOHOCRMSDK::Wizards::WizardsOperations.new
			param_instance =  ZOHOCRMSDK::ParameterMap.new
			param_instance.add(ZOHOCRMSDK::Wizards::WizardsOperations.GetWizardbyIDParam.layout_id, "3477061091055")
					...
					if response_handler.is_a? ZOHOCRMSDK::Wizards::ResponseWrapper
						...
						wizards.each do |wizard|
							...
							if parent_wizard != nil
								print "wizard Folder  id : " + parent_wizard.id.to_s + "\n"
								print "wizard Folder  Name : " + parent_wizard.name.to_s + "\n"
							end
