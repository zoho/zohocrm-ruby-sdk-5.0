...
class Vendors
		def self.update_vendors(module_1)
			...
			record1.id = 23245234364525
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Vendor_name, "vendor_name")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Phone, "12343213")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Email, "abc@gmail.com")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Website, nil)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Gl_account,  ZOHOCRMSDK::Util::Choice.new("sales-_software"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Category, nil)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.City, "city")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Country, "counbegin")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.State, "state")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Street, "street")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Zip_code, "zipcode")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.Description, "description")
	...
	def self.initialize_and_call
			begin
				...
				module_api_name = "vendors"
				update_vendors(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
Vendors.initialize_and_call