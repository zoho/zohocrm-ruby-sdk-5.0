...
class Events
		def self.update_events(module_1)
			...
			record1.id = 32084748342793
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Events.Description, "test Events")
			start_date_time = DateTime.new(2023, 11, 02, 10, 00, 00, "+05:30")
			...
			enddatetime = DateTime.new(2023, 11, 03, 10, 00, 00, "+05:30")
	...
	def self.initialize_and_call
			begin
				...
				module_api_name = "events"
				update_events(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
Events.initialize_and_call