...
class PurchaseOrders
		def self.update_purchase_orders(module_1)
			...
			vendor_name.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.id, 34232534242421)
			...
			contact__name.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.id, 34520342342321)
	...
	def self.initialize_and_call
			begin
				...
				update_purchase_orders(module_api_name)
			rescue Exception => e
				raise e
			end
		end
