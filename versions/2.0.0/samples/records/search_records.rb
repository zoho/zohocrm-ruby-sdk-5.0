...
class SearchRecords
		def self.search_records(module_api_name)
			...
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::SearchRecordsParam.criteria, "((Last_Name:starts_with:Last Name) and (Company:starts_with:fasf\\(123\\) K))")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::SearchRecordsParam.criteria, "(External:in:TestExternal221)")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::SearchRecordsParam.email, "abc@gmail.com")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::SearchRecordsParam.phone, "234567890")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::SearchRecordsParam.word, "first Name Last Name")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::SearchRecordsParam.converted, "both")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::SearchRecordsParam.approved, "both")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::SearchRecordsParam.page, 1)
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::SearchRecordsParam.per_page, 2)
	...
	def self.initialize_and_call
			begin
				...
				search_records(module_api_name)
			rescue Exception => e
				raise e
			end
		end
