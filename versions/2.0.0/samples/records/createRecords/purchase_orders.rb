...
class PurchaseOrders
		def self.create_purchase_orders(module_1)
			...
			vendor=ZOHOCRMSDK::Record::Record.new
			vendor.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.id, 4402481054948)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Vendor_name, vendor)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Subject, "new order")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Adjustment, 30.0)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Carrier,  ZOHOCRMSDK::Util::Choice.new("fed_ex"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.PO_date, Date.new(2023, 9, 23))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.PO_number, "123123")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Excise_duty, 25.0)
			vendor_name=ZOHOCRMSDK::Record::Record.new
			vendor_name.add_field_value(ZOHOCRMSDK::Record::Field::Vendors.id, 3421423242421)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Vendor_name, vendor_name)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Tracking_number, "42231")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Sales_commission, 43.32)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Requisition_no, nil)
			contact__name=ZOHOCRMSDK::Record::Record.new
			contact__name.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.id, 342342322231)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Contact_name, contact__name)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Description, "description")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Terms_and_conditions, "details of terms and condition")
			...
			line_item_product.id = 4402480954344
	...
	#		inventory_line_item.add_key_value("product__category_1", "hardware")
			...
			product_line_tax.name="Vat"
			product_line_tax.value = 10.0
			product_line_tax.id = 4402480020810
			...
			inventory_line_item_list.push(inventory_line_item)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Purchase_Orders.Purchase_items, inventory_line_item_list)
			line_taxes=[]
	...
	def self.initialize_and_call
			begin
				...
				module_api_name = "purchase__orders"
				create_purchase_orders(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
PurchaseOrders.initialize_and_call