...
class Quotes
		def self.create_quotes(module_1)
			...
			account_name.add_key_value("name", "automated")
			account_name.add_field_value(ZOHOCRMSDK::Record::Field::Accounts.id, 440248884001)
			...
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Adjustment, 10.0)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Valid_till, Date.new(2023, 12, 10))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Team, "teamname")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Terms_and_conditions, "details of terms and conditions")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Description, "description")
			deal_name=ZOHOCRMSDK::Record::Record.new
			deal_name.add_field_value(ZOHOCRMSDK::Record::Field::Deals.id, 347706111383007)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Deal_name, deal_name)
			...
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Contact_name, contact_name)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Quote_stage,  ZOHOCRMSDK::Util::Choice.new("draft"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Carrier,  ZOHOCRMSDK::Util::Choice.new("fed_ex"))
			...
			line_item_product.id = 44024800954344
	...
	#		inventory_line_item.add_key_value("product__category_1", "hardware")
			...
			product_line_tax.id = 44024800020810
			product_line_tax.percentage = 10.0
			product_line_taxes.push(product_line_tax)
			inventory_line_item.add_key_value("line__tax", product_line_taxes)
			inventory_line_item_list.push(inventory_line_item)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Quotes.Quoted_items, inventory_line_item_list)
			line_taxes=[]
	...
	def self.initialize_and_call
			begin
				...
				create_quotes(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
Quotes.initialize_and_call