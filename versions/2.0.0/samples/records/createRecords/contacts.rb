...
class Contacts
		def self.create_contacts(module_1)
			...
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Date_of_birth, Date.new(2023, 12, 01))
			vendor_name=Record.new
	...
	def self.initialize_and_call
			begin
				...
				create_contacts(module_api_name)
			rescue Exception => e
				raise e
			end
		end
