...
class DeleteMapDependency
		def self.delete_map_dependency(layout_id, module_1, dependency_id)
	...
	def self.initialize_and_call
			begin
				...
				delete_map_dependency(layout_id, module_api_name, dependency_id)
			rescue Exception => e
				raise e
			end
		end
end
DeleteMapDependency.initialize_and_call