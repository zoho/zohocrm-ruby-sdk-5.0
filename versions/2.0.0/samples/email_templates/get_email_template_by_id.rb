...
class GetEmailTemplateById
		def self.get_email_template_by_id(email_template_id)
			...
			response = email_templates_operations.get_email_template(email_template_id)
			if response != nil
					...
					if response_handler.is_a? ZOHOCRMSDK::EmailTemplates::ResponseWrapper
						...
						email_templates.each do |email_template|
							...
							if created_by != nil
								...
								print "email_template Created By Name : " + created_by.email.to_s + "\n"
							end
							...
							if modified_by != nil
								...
								print "email_template Modified By Name : " + modified_by.email.to_s + "\n"
							end
							print "email_template ID: " + email_template.id.to_s + "\n"
							print "email_template : " + email_template.editor_mode.to_s + "\n"
	...
	def self.initialize_and_call
			begin
				...
				email_template_id = 4402480627040
				get_email_template_by_id(email_template_id)
			rescue Exception => e
				raise e
			end
		end
end
GetEmailTemplateById.initialize_and_call