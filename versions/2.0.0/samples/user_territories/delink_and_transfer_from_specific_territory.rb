...
class DelinkAndTransferFromSpecificTerritory
		def self.delink_and_transfer_from_specific_territory(user_id, territory_id)
			...
			response = users_territories_operations.delink_and_transfer_from_specific_territory(territory_id, user_id, request)
			if response != nil
	...
	def self.initialize_and_call
			begin
				...
				delink_and_transfer_from_specific_territory(user_id, territory_id)
			rescue Exception => e
				raise e
			end
		end
end
DelinkAndTransferFromSpecificTerritory.initialize_and_call
