...
class DeleteRole
		def self.delete_role(role_id)
			roles_operations =  ZOHOCRMSDK::Roles::RolesOperations.new
			param_instance =  ZOHOCRMSDK::ParameterMap.new
			param_instance.add(ZOHOCRMSDK::Roles::RolesOperations::DeleteRoleParam.transfer_to_id, 3477061026008)
...
DeleteRole.initialize_and_call