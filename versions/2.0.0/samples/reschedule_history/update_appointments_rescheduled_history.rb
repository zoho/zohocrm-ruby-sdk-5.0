...
class UpdateAppointmentsRescheduledHistory
		def self.update_appointments_rescheduled_history
			...
			reschedule_history.id = 3238748913113
	...
	def self.initialize_and_call
			begin
				...
				update_appointments_rescheduled_history
			rescue Exception => e
				raise e
			end
		end
end
UpdateAppointmentsRescheduledHistory.initialize_and_call