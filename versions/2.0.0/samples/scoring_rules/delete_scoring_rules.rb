...
class DeleteScoringRules
		def self.delete_scoring_rules
			scoring_rules_operations =  ZOHOCRMSDK::ScoringRules::ScoringRulesOperations.new
			param_instance =  ZOHOCRMSDK::ParameterMap.new
			param_instance.add(ZOHOCRMSDK::ScoringRules::ScoringRulesOperations::DeleteScoringRulesParam.ids, "440248001305275")
...
DeleteScoringRules.initialize_and_call