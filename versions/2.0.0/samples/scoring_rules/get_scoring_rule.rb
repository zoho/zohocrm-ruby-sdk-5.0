...
class GetScoringRule
		def self.get_scoring_rule(module_1, id)
			scoring_rules_operations =  ZOHOCRMSDK::ScoringRules::ScoringRulesOperations.new
			param_instance =  ZOHOCRMSDK::ParameterMap.new
			response = scoring_rules_operations.get_scoring_rule(module_1, id, param_instance)
			if response != nil
				...
				if response.is_expected
					...
					if response_handler.is_a? ZOHOCRMSDK::ScoringRules::ResponseWrapper
						...
						scoring_rules.each do |scoring_rule|
							...
							module1= scoring_rule.module
							if module1 != nil
								print "scoring_rule Module ID: " + module1.id.to_s + "\n"
								print "scoring_rule Module APIName: " + module1.api_name.to_s + "\n"
							end
	...
	def self.initialize_and_call
			begin
				...
				id = 440248001310044
				module_1 = "leads"
				get_scoring_rule(module_1, id)
			rescue Exception => e
				raise e
			end
		end
end
GetScoringRule.initialize_and_call
