...
class GetShiftHours
		def self.get_shift_hours
			shift_hours_operations =  ZOHOCRMSDK::ShiftHours::ShiftHoursOperations.new("440248020813")
...
GetShiftHours.initialize_and_call