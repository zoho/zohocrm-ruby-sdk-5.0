...
class DeleteContactRoles
		def self.delete_contact_roles(contact_role_ids)
			...
			param_instance.add(ZOHOCRMSDK::ContactRoles::ContactRolesOperations::DeleteRolesParam.ids, contact_role_ids.join(","))
	...
	def self.initialize_and_call
			begin
				...
				contact_role_ids= ["62371001", "6230333002"]
				delete_contact_roles(contact_role_ids)
			rescue Exception => e
				raise e
			end
		end
