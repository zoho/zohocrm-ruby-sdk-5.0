...
class DeleteUsersUnavailabilityHour
		def self.delete_users_unavailability_hour(id)
			users_operations =  ZOHOCRMSDK::UsersUnavailability::UsersUnavailabilityOperations.new
			response = users_operations.delete_user_unavailability_hour(id)
			if response != nil
	...
	def self.initialize_and_call
			begin
				...
				id = "440248001306056"
				delete_users_unavailability_hour(id)
			rescue Exception => e
				raise e
			end
		end
end
DeleteUsersUnavailabilityHour.initialize_and_call