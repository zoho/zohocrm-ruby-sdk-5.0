...
class DeassociateTerritoryUser 
		def self.deassociate_territory_user(user, territory)
	...
	def self.initialize_and_call
			begin
				...
				user = 323242341232312
				deassociate_territory_user(user, territory)
			rescue Exception => e
				raise e
			end
		end
end
DeassociateTerritoryUser.initialize_and_call