  ...
  module Record
    class LeadConverter
      ...
      def accounts
        ...
        # @param accounts [Record] An instance of Record

      def accounts=(accounts)
        if accounts!=nil and !accounts.is_a? Record
      ...
      def contacts
        ...
        # @param contacts [Record] An instance of Record

      def contacts=(contacts)
        if contacts!=nil and !contacts.is_a? Record
