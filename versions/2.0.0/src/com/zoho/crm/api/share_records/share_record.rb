  ...
  module ShareRecords
    class ShareRecord
      ...
      def permission
        ...
        # @param permission [Util::Choice] An instance of Util::Choice

      def permission=(permission)
        if permission!=nil and !permission.is_a? Util::Choice
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: permission EXPECTED TYPE: Util::Choice', nil, nil)
        end
