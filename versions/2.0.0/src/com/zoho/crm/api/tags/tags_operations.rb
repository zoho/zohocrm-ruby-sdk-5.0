  ...
  module Tags
    class TagsOperations
      ...
      def merge_tags(id, request)
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def add_tags(record_id, module_1, request, param_instance=nil)
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def remove_tags(record_id, module_1, request)
        if !record_id.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: record_id EXPECTED TYPE: Integer', nil, nil)
        end
        if !module_1.is_a? String
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def add_tags_to_multiple_records(module_1, request, param_instance=nil)
        if !module_1.is_a? String
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: module_1 EXPECTED TYPE: String', nil, nil)
        end
        if request!=nil and !request.is_a? NewTagRequestWrapper
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def remove_tags_from_multiple_records(module_1, request, param_instance=nil)
        if !module_1.is_a? String
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: module_1 EXPECTED TYPE: String', nil, nil)
        end
        if request!=nil and !request.is_a? ExistingTagRequestWrapper
