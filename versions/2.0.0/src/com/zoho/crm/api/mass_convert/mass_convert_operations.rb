  ...
  module MassConvert
    class MassConvertOperations
      ...
      def initialize
        ...
        # @param request [Convert] An instance of Convert
        # @return An instance of APIResponse
      # @raise SDKException
      def mass_convert(request)
        if request!=nil and !request.is_a? Convert
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: request EXPECTED TYPE: Convert', nil, nil)
        end
