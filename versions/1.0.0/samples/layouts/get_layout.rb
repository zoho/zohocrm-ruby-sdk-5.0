...
class GetLayout
		def self.get_layout(module_api_name, layout_id)
			...
			param_instance.add(ZOHOCRMSDK::Layouts::LayoutsOperations::GetLayoutsParam.module, module_api_name)
			...
			if response != nil
				...
				if response.is_expected
					...
					if response_handler.is_a? ZOHOCRMSDK::Layouts::ResponseWrapper
						...
						layouts= response_wrapper.layouts
						layouts.each do |layout|
							if layout.created_time != nil
								print "layout CreatedTime: " + layout.created_time.to_s + "\n"
							end
							if layout.convert_mapping != nil
								convert_mapping = layout.convert_mapping
								accounts = convert_mapping.accounts
								contacts = convert_mapping.contacts
								deals = convert_mapping.deals
							end
							print "layout Visible: " + layout.visible.to_s + "\n"
							created_for = layout.created_for
							if created_for != nil
								print "layout CreatedFor User-Name: " + created_for.name.to_s + "\n"
								print "layout CreatedFor User-ID: " + created_for.id.to_s + "\n"
								print "layout CreatedFor User-Email: " + created_for.email.to_s + "\n"
							end
							profiles= layout.profiles
							if profiles != nil
								profiles.each do |profile|
									print "layout Profile Default: " + profile.default.to_s + "\n"
									print "layout Profile Name: " + profile.name.to_s + "\n"
									print "layout Profile ID: " + profile.id.to_s + "\n"
									default_view = profile.defaultview
									if default_view != nil
										print "layout Profile DefaultView Name: " + default_view.name.to_s + "\n"
										print "layout Profile DefaultView ID: " + default_view.id.to_s + "\n"
										print "layout Profile DefaultView Type: " + default_view.type.to_s + "\n"
									end
								end
							end
							created_by = layout.created_by
							if created_by != nil
								print "layout CreatedBy User-Name: " + created_by.name.to_s + "\n"
								print "layout CreatedBy User-ID: " + created_by.id.to_s + "\n"
								print "layout CreatedBy User-Email: " + created_by.email.to_s + "\n"
							end
							sections= layout.sections
							if sections != nil
								sections.each do |section|
									print "layout Section DisplayLabel: " + section.display_label.to_s + "\n"
									print "layout Section SequenceNumber: " + section.sequence_number.to_s + "\n"
									print "layout Section IsSubformSection: " + section.issubformsection.to_s + "\n"
									print "layout Section TabTraversal: " + section.tab_traversal.to_s + "\n"
									print "layout Section APIName: " + section.api_name.to_s + "\n"
									print "layout Section ColumnCount: " + section.column_count.to_s + "\n"
									print "layout Section Name: " + section.name.to_s + "\n"
									print "layout Section GeneratedType: " + section.generated_type.to_s + "\n"
									print "layout Section Type: " + section.type.to_s + "\n"
									...
									if properties != nil
										print "layout Section Properties ReorderRows: " + properties.reorder_rows.to_s + "\n"
										tooltip = properties.tooltip
										if tooltip != nil
											print "layout Section Properties ToolTip Name: " + tooltip.name.to_s + "\n"
											print "layout Section Properties ToolTip Value: " + tooltip.value.to_s + "\n"
										end
										print "layout Section Properties MaximumRows: " + properties.maximum_rows.to_s + "\n"
									end
								end
							end
							print "layout buisness card: " + layout.show_business_card.to_s + "\n"
							if layout.modified_time != nil
								print "layout ModifiedTime: " + layout.modified_time.to_s + "\n"
							end
							print "layout Name: " + layout.name.to_s + "\n"
							modified_by = layout.modified_by
							if modified_by != nil
								print "layout ModifiedBy User-Name: " + modified_by.name.to_s + "\n"
								print "layout ModifiedBy User-ID: " + modified_by.id.to_s + "\n"
								print "layout ModifiedBy User-Email: " + modified_by.email.to_s + "\n"
							end
							print "layout ID: " + layout.id.to_s + "\n"
							print "layout Status: " + layout.status.to_s + "\n"
							print "layout DisplayType : " + layout.display_type.to_s + "\n"
						end
		...
		def self.print_field(field)
			...
			if field.history_tracking != nil
				...
				if module_1 != nil
					...
					print "module layout display label" + module_1.display_label.to_s + "\n"
					print "module layout api name" + module_1.api_name.to_s + "\n"
					print "module layout module_1" + module_1.id.to_s + "\n"
					print "module layout id" + module_1.module.to_s + "\n"
					print "module layout module_1 name" + module_1.module_name.to_s + "\n"
				end
			...
			if field.ui_type != nil
				print "field UI tyle " + field.ui_type.to_s + "\n"
			end
			...
			if field.display_type != nil
				print "field display type : " + field.display_type.to_s + "\n"
			end
			print "get field type" + field.type.to_s + "\n"
	...
	def self.initialize_and_call
			begin
				...
				get_layout(module_api_name, layout_id)
			rescue Exception => e
				raise e
			end
		end
