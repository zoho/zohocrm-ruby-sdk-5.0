...
class UsersTransferAndDelete
		def self.users_transfer_and_delete
			...
			transfer_and_delete.id = 329874712124
			...
			response = users_transfer_delete_operations.users_transfer_and_delete(request)
			if response != nil
	...
	def self.initialize_and_call
			begin
				...
				users_transfer_and_delete
			rescue Exception => e
				raise e
			end
		end
end
UsersTransferAndDelete.initialize_and_call