...
class GetAssignmentRules
		def self.get_assignment_rules(module_api_name)
			assignment_rule_operations =  ZOHOCRMSDK::AssignmentRules::AssignmentRulesOperations.new
			param_instance =  ZOHOCRMSDK::ParameterMap.new
			param_instance.add(ZOHOCRMSDK::AssignmentRules::GetAssignmentRulesParam.module, module_api_name)
			response = assignment_rule_operations.get_assignment_rules(param_instance)
			if response != nil
	...
	def self.initialize_and_call
			begin
				...
				get_assignment_rules(module_api_name)
			rescue Exception => e
				raise e
			end
		end
