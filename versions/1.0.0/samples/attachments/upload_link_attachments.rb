...
class UploadLinkAttachments
		def self.upload_link_attachments(module_api_name, record_id, attachment_url)
	...
	def self.initialize_and_call
			begin
				...
				attachment_url = "https://5.imimg.com/data5/_kj/_up/_my-860/zoho-crm-500x500.png"
				upload_link_attachments(module_api_name, record_id, attachment_url)
			rescue Exception => e
				raise e
			end
		end
end
UploadLinkAttachments.initialize_and_call