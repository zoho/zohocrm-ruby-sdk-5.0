...
class Campaigns
		def self.update_campaigns(module_1)
			...
			record1.id = 3223
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Campaign_name, "new Campaign")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Start_date, Date.new(2023, 12, 12))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.End_date, Date.new(2023, 12, 20))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Num_sent, 10)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Actual_cost, 100.0)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Expected_revenue, 200.0)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Type,  ZOHOCRMSDK::Util::Choice.new("webinar"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Budgeted_cost, 120.0)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Expected_response, 200)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Description, "description of campaign")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Campaigns.Status,  ZOHOCRMSDK::Util::Choice.new("active"))
	...
	def self.initialize_and_call
			begin
				...
				module_api_name = "campaigns"
				update_campaigns(module_api_name)
