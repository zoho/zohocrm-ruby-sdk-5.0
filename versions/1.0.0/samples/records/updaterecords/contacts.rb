...
class Contacts
		def self.update_contacts(module_1)
			...
			record1.id = 32324324494343
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Last_name, "last Name")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Email, "abc@gmail.com")
			accountname=ZOHOCRMSDK::Record::Record.new
			accountname.id = 3213211322321323
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Account_name, accountname)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.First_name, "first Name")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Phone, "3323")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Title, "title")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Department, nil)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Other_phone, "12132")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Home_phone, nil)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Mobile, "4141")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Fax, "fax")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Date_of_birth, Date.new(2, 12, 01))
			vendor_name=ZOHOCRMSDK::Record::Record.new
			vendor_name.id = 3121323
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Vendor_name, vendor_name)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Email_opt_out, false)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Secondary_email, "abc2@gmail.com")
			contact=ZOHOCRMSDK::Record::Record.new
			contact.id = 3322321323
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Reporting_to, contact)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Skype_id, "skype_id")
			# Address info of Contact
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Mailing_city, "city")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Mailing_country, "counbegin")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Mailing_state, "state")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Mailing_street, "street")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Mailing_zip, "zip")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Other_city, "city")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Other_country, "counbegin")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Other_state, "state")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Other_street, "street")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Other_zip, "zip")
			#
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Contacts.Description, "description")
	...
	def self.initialize_and_call
			begin
				...
				update_contacts(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
Contacts.initialize_and_call