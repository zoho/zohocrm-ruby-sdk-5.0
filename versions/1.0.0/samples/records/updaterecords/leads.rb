...
class Leads
		def self.update_leads(module_1)
			...
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Lead_source,  ZOHOCRMSDK::Util::Choice.new("advertisement"))
			record1.add_key_value("title", "title")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Phone, "11123")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Mobile, "200221")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Industry,  ZOHOCRMSDK::Util::Choice.new("erp"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Email_opt_out, true)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Email, "abc@gmail.com")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Fax, "fax")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Website, nil)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.No_of_employees, 10)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Rating,  ZOHOCRMSDK::Util::Choice.new("active"))
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Skype_id, nil)
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Secondary_email, "abc1@gmail,com")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Twitter, nil)
			# Address info of Lead
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.City, "city")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Country, "counbegin")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Street, "street")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.State, "state")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Zip_code, "501210")
			#
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Description, "description")
	...
	def self.initialize_and_call
			begin
				...
				update_leads(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
Leads.initialize_and_call