...
class Leads
		def self.create_leads(module_1)
			...
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Website, "website.com")
			...
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Skype_id, "skype123")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Secondary_email, "abc1@gmail.com")
			record1.add_field_value(ZOHOCRMSDK::Record::Field::Leads.Twitter, "twitter55")
