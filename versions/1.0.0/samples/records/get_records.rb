...
class GetRecords
		def self.get_records(module_api_name)
			...
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.approved, "both")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.converted, "both")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.converted, "both")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.cvid, "3477061087501")
			ids= ["34770614352001"]
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.ids, ids.join(","))
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.uid, "34770615181008")
			field_names= ["company", "email"]
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.fields, field_names.join(","))
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.sort_by, "email")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.sort_order, "desc")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.page, 1)
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.per_page, 1)
			startdatetime = DateTime.new(2019, 11, 20, 10, 00, 01, "+05:30")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.startdatetime, startdatetime)
			enddatetime = DateTime.new(2019, 12, 20, 10, 00, 01, "+05:30")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.enddatetime, enddatetime)
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.territory_id, "34770613051357")
			param_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsParam.include_child, "true")
			header_instance =  ZOHOCRMSDK::HeaderMap.new
			ifmodifiedsince = DateTime.new(2019, 05, 20, 10, 00, 01, "+05:30")
			header_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsHeader.If_modified_since, ifmodifiedsince)
			header_instance.add(ZOHOCRMSDK::Record::RecordOperations::GetRecordsHeader.X_external, "leads.External")
