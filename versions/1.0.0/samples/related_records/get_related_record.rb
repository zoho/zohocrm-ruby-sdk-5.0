...
class GetRelatedRecord
		def self.get_related_record(module_api_name, record_id, related_list_api_name, related_list_id, destination_folder)
	...
	def self.initialize_and_call
			begin
				...
				related_list_id = 4402481055023
				destination_folder = "/users/zohocrm-java-sdk-sample/file/"
				get_related_record(module_api_name, record_id, related_list_api_name, related_list_id, destination_folder)
			rescue Exception => e
				raise e
			end
		end
