  ...
  module Fields
    class QueryDetails
      ...
      def criteria
        ...
        # @param criteria [Hash] An instance of Hash

      def criteria=(criteria)
        if criteria!=nil and !criteria.is_a? Hash
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: criteria EXPECTED TYPE: Hash', nil, nil)
        end
        @criteria = criteria
