  ...
  module Layouts
    class SectionField < Fields::Fields
      ...
      def lookup=(lookup)
        ...
        # @return An instance of SectionSubformField
      ...
      def subform
        ...
        # @param subform [SectionSubformField] An instance of SectionSubformField

      def subform=(subform)
        if subform!=nil and !subform.is_a? SectionSubformField
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: subform EXPECTED TYPE: SectionSubformField', nil, nil)
        end
        @subform = subform
