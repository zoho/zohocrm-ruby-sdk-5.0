  ...
  module Users
    class Users < Record::Record
      ...
      def number_separator=(number_separator)
        ...
        # @return An instance of TZInfo::Timezone
      ...
      def time_zone
        ...
        # @param time_zone [TZInfo::Timezone] An instance of TZInfo::Timezone

      def time_zone=(time_zone)
        if time_zone!=nil and !time_zone.is_a? TZInfo::Timezone
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: time_zone EXPECTED TYPE: TZInfo::TimeZone', nil, nil)
        end
