  ...
  module EmailComposeMeta
    class DataMap
      ...
      def default_from
        ...
        # @param default_from [DefaultForm] An instance of DefaultForm

      def default_from=(default_from)
        if default_from!=nil and !default_from.is_a? DefaultForm
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: default_from EXPECTED TYPE: DefaultForm', nil, nil)
        end
        @default_from = default_from
        @key_modified['default_from'] = 1
      end
