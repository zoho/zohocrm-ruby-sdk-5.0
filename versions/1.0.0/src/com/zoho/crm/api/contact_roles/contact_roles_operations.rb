  ...
  module ContactRoles
    class ContactRolesOperations
      ...
      def update_roles(request)
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def delete_roles(param_instance=nil)
        ...
        # @param role [Integer] A Integer
        # @return An instance of APIResponse
      # @raise SDKException
      def get_role(role)
        if !role.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: role EXPECTED TYPE: Integer', nil, nil)
        end
        handler_instance = Handler::CommonAPIHandler.new
        api_path = ''
        api_path = api_path + '/crm/v5/Contacts/roles/'
        api_path = api_path + role.to_s
        handler_instance.api_path = api_path
        handler_instance.http_method = Constants::REQUEST_METHOD_GET
        handler_instance.category_method = 'READ'
        require_relative 'response_handler'
      ...
      class DeleteRolesParam
          @@ids =   Param.new('ids', 'com.zoho.crm.api.ContactRoles.DeleteRolesParam')
        def self.ids
          @@ids
        end
      end
