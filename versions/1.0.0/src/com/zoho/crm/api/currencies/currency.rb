  ...
  module Currencies
    class Currency
      ...
      def format
        ...
        # @param format [CurrencyFormat] An instance of CurrencyFormat

      def format=(format)
        if format!=nil and !format.is_a? CurrencyFormat
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: format EXPECTED TYPE: CurrencyFormat', nil, nil)
        end
        @format = format
