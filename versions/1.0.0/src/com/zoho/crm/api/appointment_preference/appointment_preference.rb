  ...
  module AppointmentPreference
    class AppointmentPreference
      ...
      def when_duration_exceeds
        ...
        # @param when_duration_exceeds [Util::Choice] An instance of Util::Choice

      def when_duration_exceeds=(when_duration_exceeds)
        if when_duration_exceeds!=nil and !when_duration_exceeds.is_a? Util::Choice
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: when_duration_exceeds EXPECTED TYPE: Util::Choice', nil, nil)
        end
      ...
      def deal_record_configuration
        ...
        # @param deal_record_configuration [Hash] An instance of Hash

      def deal_record_configuration=(deal_record_configuration)
        if deal_record_configuration!=nil and !deal_record_configuration.is_a? Hash
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: deal_record_configuration EXPECTED TYPE: Hash', nil, nil)
        end
